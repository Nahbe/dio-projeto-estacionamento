...
const inputNome = document.querySelector<HTMLInputElement>("#input-nome") // botão de nome
const inputPlaca = document.querySelector<HTMLInputElement>("#input-placa") // botão de placa
const patio = document.querySelector<HTMLInputElement>("#patio") // tabela de patio
...
function renderizar () {
if(patio == null) return // se não existir patio, a função para aqui, isso acaba com o problema de chegar pátio = null na linha abaixo;
patio.innerHTML = "";
...
registrar?.addEventListener('click',()=>{
    console.log("add");
    if(inputNome?.value == "" || inputPlaca?.value == null) return;
